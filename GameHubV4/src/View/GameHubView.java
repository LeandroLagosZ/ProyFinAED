...
import java.awt.*;
//Eduardo Motta, Leandro Lagos, apoyo de Jose Lima
...
public class GameHubView extends JFrame {
    ...
    private void configurarVentana() {
        ...
        setExtendedState(JFrame.MAXIMIZED_BOTH); // Iniciar en pantalla completa (maximizado)
        setLocationRelativeTo(null);
        setLayout(new BorderLayout());
        getContentPane().setBackground(BG_LIGHT);

        // Guardar sesión automáticamente al cerrar la ventana
        addWindowListener(new java.awt.event.WindowAdapter() {
            @Override
            public void windowClosing(java.awt.event.WindowEvent e) {
                mainController.getUserActionController().guardarSesionUsuario();
            }
        });
    }
